...
<div class="main">
		<h1>Create New Event</h1>
			<form method="post">
			Event Name<br>
  			<input type="text" name="event" placeholder="Event Name" required="required"><br>
			City:<br>
			...
			Type of Event:
			<input type="text" name="Type" placeholder="Type Of Event"	required="required"><br>
			Description:
			<textarea rows="4" cols="50" placeholder="Description"></textarea><br>
			<!-- END --><br>
